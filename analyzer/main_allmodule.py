...
import analyzer.dataset_allmodule as dataset_allmodule
...
if __name__ == '__main__':
    ...
    for segment_size in range(8, 9):
        ...
        x_train, x_test, y_train, y_test = dataset_allmodule.load_dataset(args.input, segment_size, use_cache=False)
